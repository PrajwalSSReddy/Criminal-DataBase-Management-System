		...
		<div id="header">
			...
			<div id="login">
				<?php if(isset($_SESSION['email'])){?>
					You are logged in as:  <b><?php echo $_SESSION['email']; ?> | Status <?php echo $_SESSION['status'] ?></b>
				<?php } else { ?>
              ...
              <form class="bs-example form-horizontal" method="post" action="" id="apply">
                <fieldset>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg-4">
                      <input class="form-control" id="national_id" placeholder="National ID Number" type="number" min="0" title="National Id required and should contain numbers only" required/>
                    </div>
                  </div>
                  <div class="form-group">
