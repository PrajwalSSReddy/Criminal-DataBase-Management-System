		...
		<div class="leftSidebar">
            ...
            <div class="blockList">
            	<ul>
                	...
                	<li><a href="report.php">Cyber Crime</a></li>
                	<li><a href="report.php">Public Curruption</a></li>
					<li><a href="report.php">Civil Rights</a></li>
					<li><a href="report.php">Drug Dealers</a></li>
           	  </ul>
          </div>
		  ...
		  <div class="titleBlock">
            ...
            <div class="blockList">
            	<ul>
                	<li><a href="report.php">Road accidents</a></li>
                	<li><a href="report.php">Traffic alerts</a></li>
					<li><a href="report.php">Terrorist alerts</a></li>
           	  </ul>
          </div>
